...
function Field({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: This component is from shadcn/ui, so it's fine.
		<div
			role="group"
			data-slot="field"
	...
	const content = useMemo(() => {
		...
		return (
			<ul className="ml-4 flex list-disc flex-col gap-1">
				{uniqueErrors.map(
					(error, index) =>
						// biome-ignore lint/suspicious/noArrayIndexKey: Made by shadcn/ui
